export const featureDefinitions = [
  ...
  },
  {
    ...
    migrations: [{ path: "supabase/migrations/0015_asset_intelligence.sql", contains: ["intelligent_assets", "asset_analysis_jobs", "row level security"] }],
  ...
  },
  {
    ...
    migrations: [{ path: "supabase/migrations/0015_asset_intelligence.sql", contains: ["ai_readable", "external_ai_allowed"] }],
  ...
  },
  {
    ...
    migrations: [{ path: "supabase/migrations/0015_asset_intelligence.sql", contains: ["asset_relations", "guard_asset_relation_rooms"] }],
