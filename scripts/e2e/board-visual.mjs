...
// Linux CI and local Chromium rasterize CJK text slightly differently.  A
// modest per-pixel threshold avoids treating antialiasing fringes as layout
// regressions while preserving the pixel-count guard for real visual drift.
