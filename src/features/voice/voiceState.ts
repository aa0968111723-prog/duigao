...
/**
 * Legacy live-only dock mapping (RoomDiscussion before V-04).
 * `reconnecting` maps to dock `connecting`, so this is false.
 * The room-stack dock uses `voiceDockShowsLeave(phase)` instead.
 */
