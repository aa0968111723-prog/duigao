...
核對時間：2026-08-29（`origin/main` @ `097a6af`，#105+#106+#107 已合）。本檔只列 `git ls-tree` 證據。
...
|---|---|---|---|
| `origin/main` | `097a6afe47cf` | **0023** | `0023_video_optimize.sql`（#107 把 #95 的 0023 帶上 main） |
| room restack `#115` | `fee48520e782` | **0023** | `0023_video_optimize.sql` (+ main 0022) |
...
| **DI renumber #118** | `5cdfe490ff80` | **0030** | `0029_design_knowledge.sql`, `0030_design_research_usage.sql` |
| AI restack | `e1ea34d6a83d` | **0030** | same **new** DI names as #118 |
...
| 0023 | `0023_video_optimize.sql` | main (#107) **and** #95 / restack | same filename now on main |
...
Room restack `#115` **casts no new migration**. `#106` / `#107` on main do **not** update this stack. Do **not** invent 0031+.
