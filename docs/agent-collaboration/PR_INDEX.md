...
| PR-WB00 | agent/canonical-whiteboard-mobile-tablet | OPEN #76（待人類審） | 白板稽核＋ADR-013/014（純文件） | rounds/wb00 |
| PR-WB01 | agent/wb01-canonical-schema | 開發完成（疊於 wb00） | canonical schema 0021-0024＋tombstone＋operations＋anchors | rounds/wb01 |
